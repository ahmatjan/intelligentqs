			...
			<div class="col-md-6">
				<form class="form-signin" role="form" name="userLogin"
					...
					<input type="password" name="user_password" id="user_password"
						...
						placeholder="Auth-code" name="vercode"> <img alt="验证码"
						...
						style="color: red;">忘记密码?</a></label>
					<button class="btn btn-lg btn-primary btn-block" type="submit">登录</button>
					<br>
					<div>
						<div style="float: left;vertical-align: middle;"><a href='userRegister.jsp'>用户注册</a></div>
